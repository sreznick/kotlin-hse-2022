...
internal class NDArrayTest {
    ...
    fun testWithAddDifferentShape() {
        ...
        assertDoesNotThrow { data.add(data2) }

        assertEquals(38, data.at(DefaultPoint(2, 2, 0)))
        assertEquals(132, data.at(DefaultPoint(0, 1, 1)))
        assertEquals(5, data.at(DefaultPoint(2, 2, 1)))
        assertEquals(76, data.at(DefaultPoint(0, 1, 0)))
